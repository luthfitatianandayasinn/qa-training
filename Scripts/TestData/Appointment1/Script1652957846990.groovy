...
WebUI.setEncryptedText(findTestObject('Object Repository/Cura/Page_CURA Healthcare Service/input_Password_password'), password)
...
WebUI.click(findTestObject('Object Repository/Cura/Page_CURA Healthcare Service/input_Medicare_programs'))

WebUI.click(findTestObject('Object Repository/Cura/Page_CURA Healthcare Service/input_Visit Date (Required)_visit_date'))

WebUI.click(findTestObject('Object Repository/Cura/Page_CURA Healthcare Service/td_18'))

WebUI.setText(findTestObject('Object Repository/Cura/Page_CURA Healthcare Service/textarea_Comment_comment'), comment)
...
WebUI.click(findTestObject('Object Repository/Cura/Page_CURA Healthcare Service/a_CURA Healthcare_menu-toggle'))
